...
# Path to the first JSON file containing qualifying season data for 2022
season_path = "Merged_Data/Qualifying_Season_Merged_2022.json"

# Load the content of the first JSON file
with open(season_path, 'r') as file1:
    data1 = json.load(file1)

# Load the content of the second JSON file containing weather data for 2022
with open('../RawDataCollected/WebScraping/Weather_Qualifying/2022/Weather_Qualifying.json', 'r') as file2:
