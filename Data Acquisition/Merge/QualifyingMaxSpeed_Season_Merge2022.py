...
folder_path = "../RawDataCollected/WebScraping/Qualifying_Max_Speed/2022"

# Path to the second JSON file
second_json_path = "../RawDataCollected/WebScraping/Seasons/Season2022.json"
