...
pdf_folder = 'Qualifying_Max_Speed/Qualifying_Session_Max_Speed_2022'
...
for filename in os.listdir(pdf_folder):
    if filename.endswith('.pdf'):
        ...
        output_path = os.path.join('../RawDataCollected/WebScraping/Qualifying_Max_Speed/2022', output_file)
