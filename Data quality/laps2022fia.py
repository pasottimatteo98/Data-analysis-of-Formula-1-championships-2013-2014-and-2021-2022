...
nomi_gran_premi = {
    "bahrain": 1124, "saudi-arabia": 1125, "australia": 1108, "italy": 1109, "miami": 1110, "spain": 1111,
    "monaco": 1112, "azerbaijan": 1126, "canada": 1113, "great-britain": 1114, "austria": 1115, "france": 1116,
    "hungary": 1117, "belgium": 1118, "netherlands": 1119, "singapore": 1133, "japan": 1134, "united-states": 1135,
    "mexico": 1136, "brazil": 1137, "abu-dhabi": 1138
}
nomi_formattati = {
...
for nome, number in nomi_gran_premi.items():
    ...
    url = f"https://www.formula1.com/en/results.html/2022/races/{number}/{nome}/race-result.html"
...
url = f"https://www.formula1.com/en/results.html/2022/races/1120/italy/race-result.html"
...
print(all_data)
with open('laps2022fia.json', 'w') as json_file:
    json.dump(all_data, json_file, indent=4)

print("Data saved to laps2022fia.json")