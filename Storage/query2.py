            ...
            if isinstance(driver_data, dict):
                for gp, gp_data in driver_data.items():
                    if gp != "Circuit" and isinstance(gp_data, dict):
                        ...
                        if laps:
                            max_laps_driver = max(laps.keys(), key=lambda x: int(x))
...
for gp in averages_2013.keys():
    if gp in averages_2014.keys():
        ...
        plt.scatter(range(len(common_drivers2)), section_averages_1_2013, color='orange', marker='^',
                        label='Sezione 1 (2013)')
        plt.scatter(range(len(common_drivers2)), section_averages_2_2013, color='green', marker='^',
                        label='Sezione 2 (2013)')
        plt.scatter(range(len(common_drivers2)), section_averages_3_2013, color='blue', marker='^',
                        label='Sezione 3 (2013)')

            # Scatterplot per il 2014
        plt.scatter(range(len(common_drivers2)), section_averages_1_2014, color='orange', marker='*',
                        label='Sezione 1 (2014)')
        plt.scatter(range(len(common_drivers2)), section_averages_2_2014, color='green', marker='*',
                        label='Sezione 2 (2014)')
        plt.scatter(range(len(common_drivers2)), section_averages_3_2014, color='blue', marker='*',
                        label='Sezione 3 (2014)')
