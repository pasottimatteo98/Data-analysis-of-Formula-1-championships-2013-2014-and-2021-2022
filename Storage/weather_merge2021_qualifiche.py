...
file1_path = os.path.abspath("/Users/martaprivitera/Documents/Università magistrale DataScience/Data Management/DataMan/DataManag/DataManagement/RawDataCollected/WebScraping/Season2021.json")

# Caricare il contenuto del primo file JSON
with open(file1_path, 'r') as file1:
    data1 = json.load(file1)
# Carica il contenuto del secondo file JSON
with open('WS_weather2021_qualifiche.json', 'r') as file2:
...
with open('final2021.json', 'w') as outfile:
    json.dump(data1, outfile, indent=4)

print("Merge completato e salvato su final2021.json")