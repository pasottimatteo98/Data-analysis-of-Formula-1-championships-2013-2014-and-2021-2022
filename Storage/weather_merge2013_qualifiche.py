...
file1_path = os.path.abspath("/Users/martaprivitera/Documents/Università magistrale DataScience/Data Management/DataMan/DataManag/DataManagement/RawDataCollected/WebScraping/Season2013.json")

# Caricare il contenuto del primo file JSON
with open(file1_path, 'r') as file1:
    data1 = json.load(file1)
# Carica il contenuto del secondo file JSON
with open('WS_weather2013_qualifiche.json', 'r') as file2:
