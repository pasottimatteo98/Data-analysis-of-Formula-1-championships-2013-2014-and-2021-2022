#2022 merge qualifiche

import json
import os
# Ottenere il percorso assoluto completo del file Season2014.json
file1_path = os.path.abspath("/Users/martaprivitera/Documents/Università magistrale DataScience/Data Management/DataMan/DataManag/DataManagement/RawDataCollected/WebScraping/Season2022.json")

# Caricare il contenuto del primo file JSON
with open(file1_path, 'r') as file1:
    data1 = json.load(file1)
# Carica il contenuto del secondo file JSON
with open('WS_weather2022.json', 'r') as file2:
...
with open('final2022.json', 'w') as outfile:
    json.dump(data1, outfile, indent=4)

print("Merge completato e salvato su final2022.json")